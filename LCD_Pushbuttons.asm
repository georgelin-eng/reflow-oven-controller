...
; need to do the entier chain each time?
; logic for "checking" a push button
clr [PIN]
mov c, [SHARED_PIN] ; c has the value of `PIN`
; push button check with c instead
; code here
setb [PIN] ; put at the end
