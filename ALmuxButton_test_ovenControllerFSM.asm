...
check_Push_Button:
        ...
        cjne PB_INC_TIME_PIN, #1, checkTimeInc_FALSE
        ljmp checkTimeInc
        ...
        cjne PB_START_PIN, #1, enterOvenStateCheck_FALSE
        ...
        cjne PB_CHANGE_MENU_PIN, #1, menuState_FALSE
        ljmp menuState
        ...
        cjne PB_INC_TEMP_PIN, #1, checkTempInc_FALSE
        ljmp checkTempInc
        ...
        cjne PB_STOP_PIN, #1, STOP_PROCESS_FALSE
        ljmp STOP_PROCESS
